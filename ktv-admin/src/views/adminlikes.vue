  ...
  <div class="adminlikes">
    ...
    <div style="width: 100%; background-color: #f40">
      ...
      >
        ...
        <el-table-column label="歌曲名" prop="songName" align="center" width="150">
        </el-table-column>
        ...
        <el-table-column align="center" prop="date" width="160" label="最近更新时间">
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    onDeleteSong(song) {
      console.log(song);
      this.$confirm(
        `你确定要移除 ${song.songName} (${song.artist}) 吗?不可恢复是否继续?`,
        "提示",
        {
