<template>
  <div class="nav">
    <Menu mode="vertical" :theme="theme" width="auto">
      <Row>
        <Col :span="7">
        ...
        <MenuItem class="opera-btn" name="1">
          <Dropdown trigger="click">
            ...
            <DropdownMenu slot="list">
              <DropdownItem @click.native="goIndex"
                >你好,{{ adminInfo.username }}</DropdownItem
              >
              <DropdownItem @click.native="goManageMusic"
                >歌曲管理</DropdownItem
              >
              <DropdownItem @click.native="goAdminLikes">推荐歌曲</DropdownItem>
              <DropdownItem @click.native="goUser_service"
                >开机服务</DropdownItem
              >
