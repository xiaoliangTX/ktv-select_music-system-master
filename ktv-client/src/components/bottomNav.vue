...
export default {
    ...
    mounted(){
        setTimeout(() => {
            this.currentSong = localStorage.currentSong ? JSON.parse(localStorage.currentSong)[0] : {_id:0};
    ...
    methods:{
        ...
        reducevolume(){
            if(hasLogin()){
                $(".minormax").css("color","rgb(219, 217, 217)")
                if(this.$refs.musicPlayer.volume > 0.1){
        ...
        addvolume(){
            if(hasLogin()){
                $(".minormax").css("color","rgb(219, 217, 217)")
                if(this.$refs.musicPlayer.volume < 0.9){
                    this.$refs.musicPlayer.volume += 0.1;
                }else{
                    this.$refs.musicPlayer.volume = 1;
                }
        ...
        // 回首页
        goHome(){
            this.$route.path == "/home/index" ? null : this.$router.push("/")
        },
        // 去已选界面
        selected(){
            if(hasLogin()){
...
.bottom{
    ...
    .inner-box{
        ...
        .left{
            ...
            .selected,.addvolume,.reducevolume{
